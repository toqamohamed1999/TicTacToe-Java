...
public class OnlineList extends AnchorPane {
    ...
    public OnlineList() {
        ...
        label.setText("Online List");
        label.setTextFill(javafx.scene.paint.Color.valueOf("#ffffff"));
        label.setFont(new Font("Impact", 42.0));

        onlineListView.setLayoutX(197.0);
        onlineListView.setLayoutY(104.0);
        onlineListView.setPrefHeight(257.0);
        onlineListView.setPrefWidth(230.0);
       ...
       for(int i =1;i<=20;i++ ) {
        onlineListView.getItems().add("Item "+i);
       }
